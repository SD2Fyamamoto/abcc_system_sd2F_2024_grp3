...
<body>
    ...
    <div class="product-list-container">
        <p>商品をタップして詳細を表示</p>
        <div class="product-item" data-id="001" onclick="window.location.href='product-detail2.php'">
        ...
        <div class="product-item" data-id="003" onclick="window.location.href='product-detail2.php'">
        ...
        <div class="product-item" data-id="004" onclick="window.location.href='product-detail2.php'">
        ...
        <div class="product-item" data-id="005" onclick="window.location.href='product-detail2.php'">
        ...
        <div class="product-item" data-id="006" onclick="window.location.href='product-detail2.php'">
        ...
        <div class="product-item" data-id="007" onclick="window.location.href='product-detail2.php'">
        ...
        <div class="product-item"  data-id="008" onclick="window.location.href='product-detail2.php'">
        ...
        <div class="product-item" data-id="010" onclick="window.location.href='product-detail2.php'">
        ...
        <div class="product-item" data-id="011" onclick="window.location.href='product-detail2.php'">
        ...
        <div class="product-item" data-id="012" onclick="window.location.href='product-detail2.php'">
