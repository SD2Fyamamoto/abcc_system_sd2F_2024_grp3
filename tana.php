...
<head>
    ...
    <style>
      ...
      <body>
          ...
          <!-- タイトル -->
          <div class="title">棚</div>
      
          <!-- 商品リスト -->
          <div class="product-list-container">
              <p>商品をタップして詳細を表示</p>
              <div class="product-item" onclick="goToProductDetail()">
                  <img src="./ASOLI.img/棚　保存.avif" alt="商品画像" class="product-image">
                  <div class="product-info">
                      <div>カテゴリー：棚</div>
                      <div>商品について：収納スペースが広く、とても便利です。</div>
                      <div class="price">9,820円</div>
                  </div>
              </div>
              <div class="product-item" onclick="goToProductDetail()">
